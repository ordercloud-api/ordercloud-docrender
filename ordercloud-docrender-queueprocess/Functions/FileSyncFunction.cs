...
namespace OrderCloud.DocRender.QueueProcess
{
	public class FileSyncFunction
	{
		...
		public async Task FileSyncHandler([QueueTrigger(Consts.FileSyncQueueName, Connection = Consts.StorageConnectionSettingName)] FileChangeMessage filechange, ILogger logger)
		{
